        ...
        <div className="reviews__left">
          ...
          {is600px ? (
            <div className="reviews__text reviews__text--1">
              ...
              odio ligula, fermentum vel vehicula. Duis ligula nibh, consectetur
              vitae odio eu, maximus porta torto ermentu.
            </div>
          ) : (
            <div className="reviews__text reviews__text--1">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
              odio ligula, fermentum vel vehicula nec, fermentum sed tortor.
              Duis ligula nibh, consectetur vitae odio eu, maximus porta tortor.
              Aliquam auctor, nisi quis pellentesque vehicula.
            </div>
          )}
        ...
        <div className="reviews__right">
          ...
          {is600px ? (
            <div className="reviews__text reviews__text--4">
              Quisque condimentum ante facilisis, pellentesque augue non,
              egestas nunc. Curabitur porta turpis magna, sed tempor justo
              rhoncus non. Aenean lobortis faucibus nunc ut viverra. Vestibulum
              orci dolor, imperdiet
            </div>
          ) : (
            <div className="reviews__text reviews__text--4">
              Quisque condimentum ante facilisis, pellentesque augue non,
              egestas nunc. Curabitur porta turpis magna, sed tempor justo
              rhoncus non. Aenean lobortis faucibus nunc ut viverra. Vestibulum
              orci dolor, imperdiet in lacinia quis, malesuada rutrum massa.
              Proin eget orci sollicitudin, aliquam turpis sit amet, lobortis
              felis.
            </div>
          )}
        </div>
